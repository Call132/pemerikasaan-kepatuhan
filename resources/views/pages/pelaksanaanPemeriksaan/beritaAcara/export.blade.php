        ...
        <tbody>
            ...
            <tr>
                <td
                    ...
                    <p>
                        <span class="label">Tunggakan Iuran</span>: Rp. {{ number_format($badanUsaha->jumlah_tunggakan,
                        2, ',', '.') }}
                    </p>
                    <p>
                        <span class="label">Bulan Menunggak</span>: {{ $badanUsaha->jumlah_bulan_menunggak }} <span>(bulan)</span>
                    </p>
                    <p>
