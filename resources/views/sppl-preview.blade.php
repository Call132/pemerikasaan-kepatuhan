...
<body>
    <div class="content page1">
        <div class="right-aligned-text">Gorontalo, {{ \Carbon\Carbon::parse($sppl->tanggal_surat)->locale('id')->isoFormat('D MMMM Y') }}</div>
        ...
        <p class="indent-text">
            ...
            <strong>{{ \Carbon\Carbon::parse($badanUsaha->jadwal_pemeriksaan)->locale('id')->isoFormat('dddd, D MMMM Y') }}</strong>
    ...
    <div class="signature-container" style="text-align: right;">
        <div class="signature">
            ...
            <br><p style="margin-right: 110px;">$$</p><br>
