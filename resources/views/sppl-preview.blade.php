...
.indent-text {
    text-indent: 35px; /* Sesuaikan jumlah indentasi yang diinginkan di sini */
}
.label {
        display: inline-block;
        min-width: 143px; /* Sesuaikan dengan lebar minimum yang Anda inginkan */
        }
        .form-group p {
...
<body>
    ...
    <span class="label1">Sifat</span> : <strong>RAHASIA</strong>
      ...
      Sesuai dengan Pasal 11 huruf c Undang-Undang Republik Indonesia Nomor 24 Tahun 2011 Tentang Badan Penyelenggara Jaminan Sosial, BPJS Kesehatan diberikan kewenangan untuk melakukan Pengawasan dan Pemeriksaan Kepatuhan dalam Penyelenggaran Jaminan Kesehatan, maka bersama ini kami sampaikan, BPJS Kesehatan Cabang Gorontalo akan melakukan Pemeriksaan terhadap <strong>(Badan Usaha)</strong> dalam hal <strong>kewajiban Pembayaran Iuran</strong>.
        </p>
        <p class="indent-text" style="font-size: 16px;">
        Pemeriksaan akan dilaksanakan pada <strong>hari .... tanggal ... bulan .... tahun ....</strong> oleh Petugas Pemeriksa BPJS Kesehatan yang diberikan Surat Perintah Tugas. Untuk kelancaran jalannya Pemeriksaan, diminta agar Bapak/Ibu dapat menyediakan dan memberikan buku atau catatan dan dokumen terlampir yang diperlukan pada saat pemeriksaan dilaksanakan. Informasi lebih lanjut melalui (No hp) (Nama).
        </p>
        <p class="indent-text" style="font-size: 16px;">
...
Demi kelancaran Pemeriksaan, agar Seluruh data/informasi/dokumen yang telah disebutkan diatas dipersiapkan dan sudah kami terima saat pelaksanaan Pemeriksaan.
</p>
</body>
</html>
