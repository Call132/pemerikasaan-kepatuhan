    ...
    <div class="container">
        ...
        <div class="content page1">
            ...
            <p style="text-align: right; margin-bottom:-8px; margin-right: 5px">Gorontalo, {{
                \Carbon\Carbon::parse($spt->tanggal_spt)->translatedFormat('d F Y') }}</p>
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ \Carbon\Carbon::parse($data->tanggal_terakhir_bayar)->translatedFormat('d F Y')
                                    }}</td>
                                <td>Rp{{ number_format(floatval(str_replace(['Rp ', '.'], '', $data->jumlah_tunggakan)),
                                    2, ',', '.') }}
                                </td>
                                <td>{{ $data->jenis_pemeriksaan }}</td>
                                <td>{{ \Carbon\Carbon::parse($data->jadwal_pemeriksaan)->translatedFormat('d F Y') }}
                                </td>
                            </tr>
                            @php
