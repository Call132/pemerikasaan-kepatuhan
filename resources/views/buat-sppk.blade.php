                            ...
                            <div class="panel panel-default">
                                <form method="POST" action="{{ route('sppk.store') }}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="nomor_sppk" name="nomor_sppk"
                                            required>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" id="hari_tanggal_pelaksanaan"
                                            name="hari_tanggal_pelaksanaan" required value="{{ $id->jadwal_pemeriksaan }}">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="petugas_pemeriksa_nama"
                                            name="petugas_pemeriksa_nama" value="{{ $timPemeriksa->nama }}" required>
                                    </div>

                                    <div class="form-group">
                                        <label for="petugas_pemeriksa_npp">NPP:</label>
                                        <input type="text" class="form-control" id="petugas_pemeriksa_npp"
                                            name="petugas_pemeriksa_npp" value="{{ $timPemeriksa->npp }}" required>
                                    </div>
