    ...
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="nav-item dropdown {{ $type_menu === 'dashboard' ? 'active' : '' }}">
                <a href="{{ url('/') }}" class="nav-link has-dropdown"><i class="fas fa-fire"></i><span>Perencanaan
                        Pemeriksaan</span></a>
            ...
            <li class="nav-item {{ $type_menu === 'spt' ? 'active' : '' }}">
                <a href="{{ url('/spt') }}" class="nav-link has-dropdown"><i class="fas fa-fire"></i><span>Surat
                        Perintah Tugas</span></a>
                <ul class="dropdown-menu">
                    <li class='{{ Request::is('spt') ? 'active' : '' }}'>
                        <a class="nav-link" href="{{ url('/spt') }}">Buat SPT</a>
                    </li>
                    <li class='{{ Request::is('spt-preview') ? 'active' : '' }}'>
                        <a class="nav-link" href="{{ url('/spt/preview') }}">preview</a>
                    </li>
                </ul>
            </li>
            <li class="nav-item {{ $type_menu === 'spt' ? 'active' : '' }}">
                <a href="{{ url('/spt') }}" class="nav-link has-dropdown"><i class="fas fa-fire"></i><span>Pengiriman
                        Surat</span></a>
                <ul class="dropdown-menu">
                    <li class='{{ Request::is('sppk') ? 'active' : '' }}'>
                        <a class="nav-link" href="{{ url('/sppk') }}">Buat SPPK</a>
