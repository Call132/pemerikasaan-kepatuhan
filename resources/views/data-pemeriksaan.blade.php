                                    ...
                                    <div class="card-body">
                                        <form
                                            ...
                                            <div class="panel-body">
                                                ...
                                                <div class="form-group">
                                                    <label for="tanggal_terakhir_bayar"
                                                        class="col-md-4 control-label">Tanggal Terakhir Bayar</label>
                                                    <div class="col-md-100">
                                                        <input id="tanggal_terakhir_bayar" type="date"
                                                            class="form-control" name="tanggal_terakhir_bayar" required>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    <label for="jenis_pemeriksaan" class="col-md-4 control-label">Jenis
                                                        Pemeriksaan</label>
                                                    <div class="col-md-100">
                                                        <input id="jenis_pemeriksaan" type="text" class="form-control"
                                                ...
                                                <div class="form-group">
                                                    <label for="jadwal_pemeriksaan" class="col-md-4 control-label">Jadwal
                                                        Pemeriksaan</label>
                                                    <div class="col-md-100">
                                                        <input id="jadwal_pemeriksaan" type="date"
                                                            class="form-control" name="jadwal_pemeriksaan" required>
                                                    </div>
                                                </div>
