...
<div class="main-content">
    <section class="section">
        <div class="section-header">
            <h1>Form Surat Panggilan Pemeriksaan Kantor</h1>
        </div>
    ...
    <form action="{{ route('sppk.store') }}" method="POST">
        @csrf
        <div class="card col-12 mt-1">
            <div class="card-header">
                <h4>Data Surat Panggilan Pemeriksaan Kantor</h4>
            </div>
            <div class="card-body">
                ...
                <div class="row mb-3">
                    <div class="col-12 col-md-3">
                        <label for="nomor_sppk" class="mb-md-0 w-100 mb-2 text-start">Nomor Surat Panggilan Pemeriksaan
                            Kantor :
                        </label>
                    </div>
                    <div class="col-12 col-md-9">
                        <input type="text" name="nomor_sppk" id="nomor_sppk" class="form-control" required>
                    </div>
                </div>
                <div class="row mb-3">
                    <div class="col-12 col-md-3">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-12 col-md-9">
                        <input type="text" name="waktu" id="hari_tanggal_pelaksanaan" class="form-control" timezone="Asia/Singapore" required>
                    </div>
                </div>
            </div>
        </div>
