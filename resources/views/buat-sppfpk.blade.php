                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            <form method="POST" action="{{ route('sppfpk.store') }}" id="myForm">
                                @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <input value="{{ $timPemeriksa->nama }}" type="text" class="form-control"
                                        id="petugas_pemeriksa_nama" name="petugas_pemeriksa_nama" disabled>
                                </div>

                                <div class="form-group">
                                    <label for="petugas_pemeriksa_npp">NPP:</label>
                                    <input value="{{ $timPemeriksa->npp }}" type="text" class="form-control"
                                        id="petugas_pemeriksa_npp" name="petugas_pemeriksa_npp" disabled>
                                </div>
                                ...
                                <button type="submit" class="btn btn-primary" onclick="submitForm()">Buat SPPFK</button>
                            </form>
                        </div>
                    </div>
                </div>
