...
<body>
    ...
    <span class="label1">Hal</span> : Panggilan Pemeriksaan
      ...
      <p class="indent-text" style="font-size: 16px;">
            Sesuai dengan Pasal 11 huruf c Undang-Undang Republik Indonesia Nomor 24 Tahun 2011 Tentang Badan Penyelenggara Jaminan Sosial, BPJS Kesehatan berwenang melakukan pemeriksaan atas kepatuhan Pemberi Kerja pada Program Jaminan Kesehatan BPJS Kesehatan Cabang Gorontalo akan melakukan Pemeriksaan terhadap <strong>(Badan Usaha)</strong> dalam hal kewajiban <strong>Pembayaran Iuran</strong>. Untuk itu kami harapkan kehadiran Bapak/Ibu dengan membawa buku, catatan, dan dokumen pendukung sebagaimana terlampir dan memberikan keterangan yang diperlukan pada:
        </p>
        <div class="section">
