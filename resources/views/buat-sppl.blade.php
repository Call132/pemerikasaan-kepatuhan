                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="panel panel-default">
                                <form method="POST" action="{{ route('sppl.store') }}">
                                    @csrf
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="kode_entitas"
                                            name="kode_entitas"disabled value="{{ $badanUsaha->kode_badan_usaha }}"
                                            required>
                                    </div>
